...
begin
  ...
  Assert.IsTrue(Pos('<h1>DX.Comply Software Release Assessment (SRA) and SBOM Compliance Report</h1>', LContent) > 0);
  ...
  Assert.IsTrue(Pos('<a href="bom.json"><code>bom.json</code></a>', LContent) > 0);
